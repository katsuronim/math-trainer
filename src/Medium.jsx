...
function Medium() {
    const [varOne, setVarOne] = useState(Math.floor(Math.random() * 100));
    const [varTwo, setVarTwo] = useState(Math.floor(Math.random() * 100));
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-orange-300 to-red-400 p-6 text-center">
                <Link
                    to="/"
